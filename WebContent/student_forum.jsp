...
String qr = "select * from forum where student_id = "+student_id+" ";
...
while(rs.next())
{
	...
	String ss = rs.getString("answer");
	String temp;
	if(ss.equals(" "))
	{
		temp = "NOT ANSWERED YET";
	}
	else 
	{
		temp = rs.getString("answer");
	}
...
%>
                      ...
                      <form action="student_forum_2.jsp">
