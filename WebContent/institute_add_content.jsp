                                ...
                                <div class="card" style="width: 60rem; height: 100%;">
                                    ...
                                    <div class="card-body " >
                                        ...
                                        <form action="UploadServlet.jsp" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="file" style=" margin-left:10%; margin-top:2%;" name="file" size="500" accept="application/pdf, .ppt, .pptx, application/vnd.ms-excel, application/vnd.ms-powerpoint,
                                  text/plain, image/*" /> 
                                            <input type="submit" style="height:25%" id="buttonSlogin" value="Upload File" />
                                        </form>
